...
public class OpenRouterService {
    ...
    public Map<String, String> analizarYAdaptar(String urlOferta, String descripcionTexto, String cvBase) {
        ...
        String prompt = "Actúa como un experto en reclutamiento técnico. Analiza minuciosamente la siguiente oferta:\n"
                ...
                + "MANTÉN la estructura, secciones y datos verídicos de mi currículum original, reescribiendo o destacando las tecnologías que piden.\n"
                + "Escribe el CV en MARKDOWN estricto y con este formato EXACTO:\n"
                + "- Primera línea: # NOMBRE Y APELLIDOS (sin nada más en esa línea)\n"
                + "- Justo debajo, una línea por contacto: Email: ..., Teléfono: ..., LinkedIn: ..., Ubicación: ... (solo las que existan)\n"
                + "- Cada sección en una línea: ## NOMBRE DE LA SECCIÓN (en MAYÚSCULAS)\n"
                + "- Cada puesto, proyecto o ítem como punto: - Texto\n"
                + "- Puestos/roles destacados en negrita con **texto**\n"
                + "- Sin tablas, sin listas numeradas, sin HTML.\n"
                + "Currículum base a adaptar:\n"
                + cvBaseReal + "\n\n"
                + "[CARTA]\n"
