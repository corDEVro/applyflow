...
public class CVService {
    ...
    public String extraerTextoDocx(MultipartFile file) throws Exception {   // Extrae todo el texto plano de un documento .docx para usarlo como CV base.
